...
#initSwiftExtension(
    ...
    enums: [
        ...
        ARWorldTrackingConfiguration.SceneReconstruction.self,
        ARFrame.WorldMappingStatus.self,
        ARCamera.TrackingState.self,
        ARCamera.TrackingStateReason.self,
        ARPlaneAnchor.Alignment.self,
        ARPlaneAnchor.ClassificationStatus.self,
        ARPlaneAnchor.Classification.self,
        ARRaycastQuery.Target.self,
        ARRaycastQuery.TargetAlignment.self,
        ARRaycastResult.Target.self,
        ARRaycastResult.TargetAlignment.self,
        ARMeshAnchor.MeshClassification.self,
        ARFaceAnchor.BlendShapeLocation.self,
        ARHandAnchor.Chirality.self,
        ARHandSkeleton.JointName.self,
        ARCoachingOverlay.Goal.self,
        ARWorldTrackingConfiguration.FrameSemantics.self,
        ARGeoAnchor.AltitudeSource.self,
        ARCollaborationData.Priority.self,
    ],
    registerDocs: true
)
